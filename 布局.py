...
import qdarkstyle
import qdarkstyle.pyqt5_style_rc  # 导入pdarkstyle资源文件
from PyQt5 import QtCore
from PyQt5.QtCore import Qt, QPoint, QUrl, pyqtSignal, pyqtSlot
...
editor_path = os.path.join(os.getcwd(), r'quant\python_editor\editor.htm')
...
class Editor(QWidget):
    def __init__(self):
        ...
        with open(r'C:\Users\xiaok\Desktop\PYQT5CodeEditor\qdark.qss', encoding='utf-8') as f:
    ...
    def create_stragety_vbox(self):
        ...
        self.strategy_tree.setRootIndex(self.model.index(r'C:\Users\xiaok\Desktop\PYQT5CodeEditor\strategy'))
